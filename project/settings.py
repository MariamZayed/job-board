...
SECRET_KEY = 'django-insecure-de=01b3^d2&)3yv1)e(*ujt+x!1#t&-7jy1y1y5kks59tpf*#5'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates'],# add this directory to indcate templates in home directory, I'll call it when I ever extend base.html
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'project.context_processors.category_list',
            ],
        },
    },
]
...
EMAIL_PORT = '587'
EMAIL_HOST_USER =  'iti.mans.projects@gmail.com'
